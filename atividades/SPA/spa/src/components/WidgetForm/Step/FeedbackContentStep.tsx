...
import { ApiRequest, FeedbackType, feedbackTypes } from '../constAndTypes';
...
export function FeedbackContentStep({
  ...
  async function handleScreenshot(screenshot: string | null) {
  ...
  async function handleSubmitFeedback(event: FormEvent) {
    ...
    const info: ApiRequest = {
      type: feedbackType,
      screenshot,
      comment,
    };

    console.log(await axios.post('https://tnm0d8qdza.execute-api.us-east-1.amazonaws.com/dev/sendMessage', info));
    ...
    <>
      ...
      <form className="my-4 w-full">
        ...
        <footer className="flex gap-2 mt-2">
          <ScreenshotButton screenshot={screenshot} onScreenshotTook={handleScreenshot} />
          <button
            type="submit"
